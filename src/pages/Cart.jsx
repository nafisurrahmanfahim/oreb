...
import { incrementProduct, decrementProduct, removeProduct } from "../components/slice/productSlice";


const Cart = () => {
  let data = useSelector((state) => state.product.cartItem);
  let dispacth = useDispatch()
  let handleIncremen = (index)=> {
    dispacth(incrementProduct(index))
  }

  let handleDecrement = (index)=> {
    dispacth(decrementProduct(index))
  }

  let handleDelete = (index) => {
    dispacth(removeProduct(index))
  }
                    ...
                    <ul className="flex p-[10px] items-center justify-between">
                      ...
                      <li className="w-[20%] font-bold p-[10px] relative">
                        ...
                        <div className="arrows flex flex-col absolute top-[50%] right-0 translate-y-[-50%]">
                          <div className="" onClick={()=> handleIncremen(i)}>
                            <TfiArrowCircleUp />
                          </div>
