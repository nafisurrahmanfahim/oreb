...
const Post = ({ allPage, categoryFilter }) => {
    ...
    useEffect(() => {
        let filterSlise = categoryFilter.slice(0, 5)
        setShowFilter(filterSlise)
    }, [categoryFilter])
            ...
            {showFilter.length > 0 ? (
                <>
                    ...
                    <div className="cursor-pointer">
                        {count ? categoryFilter.length > 5 && <h3 onClick={handleShow}>Show All</h3> : categoryFilter.length > 5 && <h3 onClick={handleLess}>Less</h3>}
                    </div>
